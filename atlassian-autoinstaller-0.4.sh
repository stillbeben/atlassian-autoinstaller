...
#                                                                           #
# Version: 0.4 / Date: 21st February 2014                                   #
#                                                                           #
...
if [ $? -ne 1 ] ; then
	...
	jiradatapath="/var/atlassian/application-data/jira"
...
if [ $? -ne 1 ] ; then
	...
	confluencedatapath="/var/atlassian/application-data/confluence"
...
if [ $installjira -ne 0 ] ; then
	echo "* JIRA $jiraversion"
fi
if [ $installconfluence -ne 0 ] ; then
	echo "* Confluence $confluenceversion"
fi
if [ $installbamboo -ne 0 ] ; then
	echo "* Bamboo $bambooversion"
fi
if [ $installstash -ne 0 ] ; then
	echo "* Stash $stashversion"
fi
if [ $installfisheye -ne 0 ] ; then
	echo "* Fisheye & Crucible $fisheyeversion"
fi
if [ $installcrowd -ne 0 ] ; then
	echo "* Crowd $crowdversion"
fi
echo""
...
if [ $installjira -ne 0 ] ; then
	...
	/tmp/$productjira-$jiraversion-$arch.bin
